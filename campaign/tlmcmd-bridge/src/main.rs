...
use tmtc_c2a::{kble_gs, proto, registry, satellite, Satconfig, influxdb};
...
async fn main() -> Result<()> {
    ...
    let store_to_influxdb_hook = influxdb::StoreToInfluxDBHook::new(args.campaign_id, args.campaign_start_timestamp_ms);
